...
class Online_Exam{
	...
	if(data.containsKey(Username)){
	    ...
	    System.out.println("Ooops!..User doesn't Exists, Please Register to login");
	}
        return log;
    }
    ...
    public void Update_Username(){
        ...
        if(!(User.equals(this.UserName))){
            System.out.print("Confirm New User Name to Update: ");
            User1=input.nextLine();
            if(User.equals(User1)){
                System.out.println("Congratulations!..Username Updated Successfully...");
                this.UserName=User1;
                return;
            }
            else{
            ...
            System.out.println("New Username and Present Username cannot be same...");
            Update_Username();
        }
    }
    public void Update_PassWord(){
        ...
        if(!(Pass.equals(this.Password))){
            System.out.print("Confirm New Password to Update: ");
            ...
            System.out.println("New Password and Present Password cannot be same...");
            Update_PassWord();
        }
    }
	...
	System.out.print("Your choice: ");
        ...
        if(ch==1){
            ...
            System.out.println("Each Question carries 10 marks"+" "+" -5 will be deducted for wrong answers");
            System.out.println("You will be given 45 seconds to answer 5 questions");
            attempt=0;
            while(System.currentTimeMillis()<endtime){
		count=0;
                System.out.println("Question 1. 11*2+6 = ?");
                System.out.println("Option 1. 28\nOption 2. 31\nOption 3. 14\nOption 4. 55\n");
    ...
    public static void main(String args[]){
        Scanner input=new Scanner(System.in);
        System.out.println("____WELCOME TO ONLINE EXAMINATION___");
